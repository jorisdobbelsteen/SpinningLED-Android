...
// Based on
// https://github.com/TheEvilRoot/async-coroutines-socket/blob/master/src/main/kotlin/com/theevilroot/asyncsocket/CoroutineSocket.kt
//
//
...
open class CoroutineSocket(
    ...
    private val readTimeout: Pair<Long, TimeUnit>? = null
) {
